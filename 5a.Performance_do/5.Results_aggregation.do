...
sum rel_bias_CIF2
 ...
 export delimited using "$N\5b.Performance_results/R_long.csv", replace
  export delimited using "Z:/StudyI/Nick_Simulation/Simulation_mod/Simulation_code/dotplot//R_long.csv", replace
 restore
...
export delimited using "$N\5b.Performance_results/Rtable_sim_agegender_nick.csv", replace
