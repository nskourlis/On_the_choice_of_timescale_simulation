...
clear all  
include "$N/1b.Scenarios_folder/Scenario2_new.do"
...
// function to predict hazard function for other cause mortality

real matrix hazard2(t,age,alpha,lambda,gamma, bsex_c2, bsex_c2_tvc_1, bsex_c2_tvc_2) 
{
    return(
	((alpha :+lambda:* gamma:*(age:+t):^(gamma:-1)):*exp(bsex_c2 :+ bsex_c2_tvc_1:*(age:+t) :+ bsex_c2_tvc_2:*(age:+t):^2)  ) )
	
}

hazard2((1..10),80,alpha,lambda,gamma,bsex_c2, bsex_c2_tvc_1, bsex_c2_tvc_2)

// function to predict survival function for other cause mortality
...
// function to predict survival function for cancer mortality
...
// function to predict hazard function for cancer mortality
...
// function to predict CIF for cancer mortality (CIF1)
...
// evaluation of each node requires numerical integration
 ...
 // function to predict CIF for cancer mortality (CIF2)
...
save "$N\2b.Truths_folder/True_CIFs_scenario2", replace
...
use "$N\2b.Truths_folder/True_CIFs_scenario2", replace


/*************************************************************************************/
 
clear all  
include "$N/1b.Scenarios_folder/Scenario4_new.do"
...
save "$N\2b.Truths_folder/True_CIFs_scenario4", replace
...
clear all  
include "$N/1b.Scenarios_folder/Scenario14_new.do"
...
save "$N\2b.Truths_folder/True_CIFs_scenario14", replace
...
clear all  
include "$N/1b.Scenarios_folder/Scenario16_new.do"
...
save "$N\2b.Truths_folder/True_CIFs_scenario16", replace
