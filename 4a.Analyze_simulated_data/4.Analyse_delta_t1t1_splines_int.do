...
//Analysis over the scenarios
	...
	// file to store results
 	postutil clear
   	...
   	postfile sim_t1t1_splines_int CIF1_f1_at1 CIF1_f1_at2 CIF1_f1_at3 CIF1_f1_at4 CIF1_f1_at5 CIF1_f1_at6 CIF1_f1_at7 CIF1_f1_at8 CIF1_f1_at9 CIF1_f1_at10 ///
					  ...
					  hr_gender_at6 hr_gender_at7 hr_gender_at8 hr_gender_at9 hr_gender_at10 givenage canc_model_converged other_model_converged ///
			          using ///		 
					 "$N\4b.Analyze_results\Approach_d_splines_int/scenario`scen'_spline_int.dta", replace
...
//Analysis for each dataset
    ...
    //Analysis allowing only proportional hazards for gender
		...
		if "$prop_sex_other"=="PH_sex_other" {
			...
			capture stpm2 agercs1 agercs2 agercs3 agercs4 female , df(5) tvc(agercs1 agercs2 agercs3 agercs4) ///
															dftvc(agercs1:3 agercs2:3 agercs3:3 agercs4:3) ///
															failconvlininit  iter(100) scale(hazard)  eform 	
	...
	//Analysis allowing non proportional hazards for gender
			...
			capture stpm2 agercs1 agercs2 agercs3 agercs4 female , df(5) tvc(agercs1 agercs2 agercs3 agercs4 female) ///
			                                               dftvc(agercs1:3 agercs2:3 agercs3:3 agercs3:3 agercs4:3  female:2) ///
														   failconvlininit  iter(100) scale(hazard)  eform 	
	...
	/*for the specific loop for the simulated dataset where convergence was not achieved*/ 
	
	if `canc_model_converged'==1 & `other_model_converged'==1 {
...
//Use of the standsurv to derive the CIF estimates and the confidence intervals
	...
	toffset(. .)         /// offset for  */ /// 
	at1(female 1 agercs1 `c${age}_1_loop' agercs2 `c${age}_2_loop' agercs3 `c${age}_3_loop' agercs4 `c${age}_4_loop' ) /// 
	at2(female 0 agercs1 `c${age}_1_loop' agercs2 `c${age}_2_loop' agercs3 `c${age}_3_loop' agercs4 `c${age}_4_loop' ) /// 
	ode odeoptions(maxsteps(100000))
...
local j=`j'+1
    ...
    predict hr_gender${age}, hrnum(female 1 agercs1   `c${age}_1_loop' agercs2 `c${age}_2_loop' agercs3 `c${age}_3_loop' agercs4 `c${age}_4_loop') ///
					         hrdenom(female 0 agercs1 `c${age}_1_loop' agercs2 `c${age}_2_loop' agercs3 `c${age}_3_loop' agercs4 `c${age}_4_loop') timevar(tt1) 
	local p=1 
	foreach x in $times {
...
// store results
		...
		post sim_t1t1_splines_int (`CIF1_f1_at1') (`CIF1_f1_at2') (`CIF1_f1_at3') (`CIF1_f1_at4') (`CIF1_f1_at5') (`CIF1_f1_at6') (`CIF1_f1_at7') (`CIF1_f1_at8') (`CIF1_f1_at9') (`CIF1_f1_at10') ///
					  (`CIF1_f1_at1_LL') (`CIF1_f1_at1_UL') (`CIF1_f1_at2_LL') (`CIF1_f1_at2_UL') (`CIF1_f1_at3_LL') (`CIF1_f1_at3_UL') (`CIF1_f1_at4_LL') (`CIF1_f1_at4_UL') (`CIF1_f1_at5_LL') (`CIF1_f1_at5_UL') ///
					  (`CIF1_f1_at6_LL') (`CIF1_f1_at6_UL') (`CIF1_f1_at7_LL') (`CIF1_f1_at7_UL') (`CIF1_f1_at8_LL') (`CIF1_f1_at8_UL') (`CIF1_f1_at9_LL') (`CIF1_f1_at9_UL') (`CIF1_f1_at10_LL') (`CIF1_f1_at10_UL') ///
					  (`CIF2_f1_at1') (`CIF2_f1_at2') (`CIF2_f1_at3') (`CIF2_f1_at4') (`CIF2_f1_at5') (`CIF2_f1_at6') (`CIF2_f1_at7') (`CIF2_f1_at8') (`CIF2_f1_at9') (`CIF2_f1_at10') ///
					  (`CIF2_f1_at1_LL') (`CIF2_f1_at1_UL') (`CIF2_f1_at2_LL') (`CIF2_f1_at2_UL') (`CIF2_f1_at3_LL') (`CIF2_f1_at3_UL') (`CIF2_f1_at4_LL') (`CIF2_f1_at4_UL') (`CIF2_f1_at5_LL') (`CIF2_f1_at5_UL') ///
...
// store results
	...
	// close postfile
	postclose sim_t1t1_splines_int
}
